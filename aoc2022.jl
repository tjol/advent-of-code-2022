...
function run(day)
    ...
    elseif day == 16
        checkresult(day16part1, "day16/demoinput", 1651)
        # checkresult(day16part2, "day16/demoinput", 56000011)
        printresult(day16part1, "day16/input")
        # printresult(day16part2, "day16/input")
    end
end
